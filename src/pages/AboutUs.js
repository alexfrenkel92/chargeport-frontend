...
function aboutUs () {
  return (
    <div className='aboutus'>
      ...
      <p>A backend-ről származó DB adatok a https://www.freemysqlhosting.net/ oldalon vannak tárolva, aminek a rendelkezésre állása korlátozott, így előfordulhat, hogy néhány adat nem mindig tölt be.</p>
    </div>
  );
}
